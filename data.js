...
var PASSES = [
  ...
  // 3. EP4 ミニオン＆ハリウッド・ドリーム
  {
    id: "ep4_minion_hollywood",
    name: "エクスプレス・パス 4\n〜ミニオン＆ハリウッド・ドリーム・ザ・ライド〜",
    shortName: "EP4 ミニオン＆ハリウッド・ドリーム",
    type: "ep4",
    color: "#27AE60",
    colorBg: "#E8F8EF",
    borderColor: "#27AE60",
  ...
  // 13. EP4 トロッコ＆ジュラシック・パーク
  {
    id: "ep4_trolley_jurassic",
    name: "エクスプレス・パス 4\n〜トロッコ＆ジュラシック・パーク〜",
    shortName: "EP4 トロッコ＆ジュラパ",
    type: "ep4",
    color: "#27AE60",
    colorBg: "#E8F8EF",
    borderColor: "#27AE60",
  ...
  // 14. EP4 ミニオン＆シアター（4月限定）
  {
    id: "ep4_minion_theater",
    name: "エクスプレス・パス 4\n〜ミニオン＆シアター〜",
    shortName: "EP4 ミニオン＆シアター",
    type: "ep4",
    color: "#27AE60",
    colorBg: "#E8F8EF",
    borderColor: "#27AE60",
  ...
  // 15. EP4 レース＆シアター（4月限定）
  {
    id: "ep4_race_theater",
    name: "エクスプレス・パス 4\n〜レース＆シアター〜",
    shortName: "EP4 レース＆シアター",
    type: "ep4",
    color: "#27AE60",
    colorBg: "#E8F8EF",
    borderColor: "#27AE60",
  ...
  // 16. EP4 バックドロップ＆レース（4月限定）
  {
    id: "ep4_backdrop_race",
    name: "エクスプレス・パス 4\n〜バックドロップ＆レース〜",
    shortName: "EP4 バックドロップ＆レース",
    type: "ep4",
    color: "#27AE60",
    colorBg: "#E8F8EF",
    borderColor: "#27AE60",
